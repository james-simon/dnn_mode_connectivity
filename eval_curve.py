...
EvalCurveArgSet = collections.namedtuple('EvalCurveArgSet', ['dir', 'ckpt', 'num_points', 'dataset', 'use_test', 'transform', 'data_path', 'batch_size',
                                     'num_workers', 'model', 'curve', 'num_bends', 'wd'])
def evaluate_curve(dir='/tmp/curve/', ckpt=None, num_points=61, dataset='CIFAR10', use_test=True, transform='VGG',
                data_path=None, batch_size=128, num_workers=4, model_type=None, curve_type=None,
                num_bends=3, wd=1e-4):
    args = EvalCurveArgSet(dir=dir, ckpt=ckpt, num_points=num_points, dataset=dataset, use_test=use_test, transform=transform,
                data_path=data_path, batch_size=batch_size, num_workers=num_workers, model=model_type, curve=curve_type,
                num_bends=num_bends, wd=wd)
